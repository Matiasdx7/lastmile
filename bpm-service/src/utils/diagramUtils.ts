import { ProcessDiagram, ProcessNode, ProcessEdge } from '../models/BpmModel';

/**
 * Generate HTML for a BPM diagram using Mermaid
 */
export function generateDiagramHtml(diagram: ProcessDiagram, title: string): string {
 ...
 */
function convertToMermaidSyntax(diagram: ProcessDiagram): string {
 ...
 */
function generateMetricsHtml(diagram: ProcessDiagram): string {
  let html = '';
